  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12" sm="5">
        ...
        <br />
        <p>
          Betalen in schijven is steeds mogelijk mits overleg.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          Voor meer info: <a href="https://www.knokke-heist.be/uitpas" > https://www.knokke-heist.be/uitpas </a> of neem contact op met Tamara.
